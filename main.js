...
function draw() {
  ...
  if (gamestate === 'S1' || gamestate === 'S2' || gamestate === 'S3' || gamestate === 'S4' || gamestate === 'S5') {
    ...
    for(let i =  200; i <= windowHeight - 100; i += (windowHeight  - 100) / 11){
      strokeWeight(2)
      stroke(sin(h) * 200 + 100)
      line(200, i, windowWidth - 100, i)
    }
    for(let i = 200; i <= windowWidth - 100; i += (windowWidth - 100) / 11){
      strokeWeight(2)
      stroke(sin(h) * 200 + 100)
      line(i, 200, i, windowHeight - 100)
    }
